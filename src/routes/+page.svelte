<script lang="ts">
	import { tasks } from "$lib/state.svelte";
...
<dialog class="bg-white rounded-lg shadow-lg p-4 m-auto" bind:this={addTaskModal}>

    <form>
        <div class="flex flex-col">
            <label class="font-semibold" for="title"> Title</label>
            <input type="text" name="title" id="title" class="border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500">
        </div>
        <div class="flex flex-col">
            <label class="font-semibold" for="description"> Description</label>
            <textarea name="description" id="description" class="border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500"></textarea>
        </div>
        <div class="flex flex-col">
            ...
            <input type="datetime-local" name="date" id="date" class="border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500">
        </div>
    </form>
...
<div class="p-4 flex flex-col items-center mx-auto container">
    ...
    <div class="bg-white rounded-lg min-w-75 shadow-sm p-3 hover:shadow-lg hover:border hover:border-slate-400 ">
        <span class="text-lg ">{task.Name}</span>
        <div class="flex flex-col gap-3">
        <button type="button" onclick={() => addTaskModal.showModal()} class="flex justify-start gap-4 items-center px-2 py-1 hover:cursor-pointer hover:bg-blue-100 text-blue-600 font-semibold text-sm rounded-full">
